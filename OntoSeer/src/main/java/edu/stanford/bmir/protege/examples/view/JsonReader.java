...
public class JsonReader {
	   ...
	   // System.out.println(json.toString(4));
	    ...
	    if(total<3) {
	       ...
	       for (int i=0;i<3;i++) {
		     ...
		     Pattern p = Pattern.compile("\"_type\":\"vocabulary\"");
				// spliting the input sequence
		     if(ls.size()>1) {
				String[] str=p.split(ls.get(0), 3);
				for(String str1:str)
				{
	  ...
	  public static void main(String[] args){
		  ...
		  try {
			  ls.addAll(j.vocab("Book"));
			  System.out.println("lsfinal"+ls.toString());
			  System.out.println("lsfinal"+ls.get(0));
			  System.out.println("lsfinal"+ls.get(1));
