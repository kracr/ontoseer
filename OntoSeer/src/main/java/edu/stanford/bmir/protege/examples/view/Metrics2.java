...
public class Metrics2 extends JPanel implements ItemListener {
   ...
   //     c2.addItemListener(s); 
        ...
        l5=new JLabel("Axiom_Output");
        l3=new JLabel("Axiom_Output");
        l4=new JLabel("Axiom_Output");
        l6=new JLabel("         ");
        l7=new JLabel("         ");
        l8=new JLabel("         ");
        l9=new JLabel("         ");
    ...
    { 
        ...
        if (e.getSource() == c1) { 
            ...
            r.re(value, x);
            l3.setText("Axiom Output: "+"<Person> "+"<hasURI>"+" <SNOMEDCT_2005_07_31>");
            l4.setText("Axiom_output: "+"<Person> "+"<subClassOf> "+">HP_0000708>");
